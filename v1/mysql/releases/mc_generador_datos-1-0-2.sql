...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-09-2023 a las 23:03:48
...
--
-- Estructura de tabla para la tabla `sistema_tipo_usuarios`
--
...
--
-- Volcado de datos para la tabla `sistema_tipo_usuarios`
--

INSERT INTO `sistema_tipo_usuarios` (`id_sis_tip_usu`, `created_at`, `updated_at`, `descripcion`, `activo`) VALUES
(1, '2023-09-09 17:24:01', NULL, 'Super Administrador', 1),
(2, '2023-09-09 17:24:01', NULL, 'Colaborador', 1);
...
INSERT INTO `sistema_usuarios` (`id_usu`, `created_at`, `updated_at`, `foto_perfil`, `nombre`, `email`, `contrasenia`, `telefono`, `habilitado`, `id_tip_usu`, `activo`) VALUES
(1, '2023-09-09 18:00:44', NULL, 'https://gendata.multicode.cl/public/profile/default.png', 'Administrador Multicode', 'test@multicode.cl', '81dc9bdb52d04dc20036dbd8313ed055', '+569 0123 4567', 1, 1, 1);
...
--
-- Indices de la tabla `sistema_tipo_usuarios`
--
ALTER TABLE `sistema_tipo_usuarios`
...
--
-- AUTO_INCREMENT de la tabla `sistema_tipo_usuarios`
--
ALTER TABLE `sistema_tipo_usuarios`
  MODIFY `id_sis_tip_usu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Filtros para la tabla `sistema_usuarios`
--
ALTER TABLE `sistema_usuarios`
  ADD CONSTRAINT `FK_SISTEMA_USUARIOS_SISTEMA_TIPO_USUARIOS` FOREIGN KEY (`id_tip_usu`) REFERENCES `sistema_tipo_usuarios` (`id_sis_tip_usu`);
COMMIT;
